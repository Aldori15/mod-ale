...
ALERegister<Player> PlayerMethods[] =
{
    ...
    { "GetTravelStatSessionTotal", &LuaPlayer::GetTravelStatSessionTotal },
    { "GetTravelStatWalked", &LuaPlayer::GetTravelStatWalked },
    { "GetTravelStatSwimming", &LuaPlayer::GetTravelStatSwimming },
    { "GetTravelStatMounted", &LuaPlayer::GetTravelStatMounted },
    { "GetTravelStatFlying", &LuaPlayer::GetTravelStatFlying },
    ...
    { "RemoveTravelStatSessionTotal", &LuaPlayer::RemoveTravelStatSessionTotal },
    { "RemoveTravelStatWalked", &LuaPlayer::RemoveTravelStatWalked },
    { "RemoveTravelStatSwimming", &LuaPlayer::RemoveTravelStatSwimming },
    { "RemoveTravelStatMounted", &LuaPlayer::RemoveTravelStatMounted },
    { "RemoveTravelStatFlying", &LuaPlayer::RemoveTravelStatFlying },
    { "AddTravelStatSessionTotal", &LuaPlayer::AddTravelStatSessionTotal },
    { "AddTravelStatWalked", &LuaPlayer::AddTravelStatWalked },
    { "AddTravelStatSwimming", &LuaPlayer::AddTravelStatSwimming },
    { "AddTravelStatMounted", &LuaPlayer::AddTravelStatMounted },
    { "AddTravelStatFlying", &LuaPlayer::AddTravelStatFlying },
